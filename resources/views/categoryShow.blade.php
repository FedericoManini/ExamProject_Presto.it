<x-layout>
    <div class="container">
        <div class="row">
            <h4 class="display-3 my-5 d-flex justify-content-center align-items-center">{{__("ui.$categoria->name") }}</h4>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-8">
                <div class="row">
                    @forelse ($categoria->articles as $article)
                        ...
                        <div class="row justify-content-center align-items-center my-3">
                            <div class="col-12 d-flex justify-content-center align-items-center">
                                <div class="col-12 d-flex justify-content-center align-items-start flex-column">
                                    <span class="display-6 my-5">Non ci sono articoli per questa categoria! Vuoi inserirne uno?</span>
